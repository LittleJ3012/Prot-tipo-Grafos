Este repositório armazena o código do prótipo de uma função que visa a entrada, processamento e saída dos dados. No caso, a função MatrizDeGrafos recebe como parâmetro a instância (nome)
